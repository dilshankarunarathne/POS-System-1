...
// If MONGO_URI is not in .env, use the Atlas URI
if (!process.env.MONGO_URI) {
  process.env.MONGO_URI = 'mongodb+srv://username:password@ac-ivafhnj.sbd7rpf.mongodb.net/bike-pos?retryWrites=true&w=majority';
}
